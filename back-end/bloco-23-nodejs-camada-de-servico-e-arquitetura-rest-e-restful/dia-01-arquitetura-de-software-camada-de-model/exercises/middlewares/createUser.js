    ...
    const createUserSchema = Joi.object({
        ...
        firstName: Joi.string().required().message({'string.min': 'O campo deve ser uma string'}),
        lastName: Joi.string().required().message({'string.min': 'O campo deve ser uma string'}),
        email: Joi.string().email().required().message({'string.email': 'informe um email válido'}),
